    ...
    <section id="experience" className="experience">
      ...
      <div className="experience-list">
        <div className="experience-item">
          ...
          <ul>
            <li>
              Leveraged technologies such as OpenAI, Node.js, and React to develop 
              Kai, an AI Teaching Assistant engineered to augment the educational 
              ecosystem by supporting instructors with intelligent program design and 
        ...
        <div className="experience-item">
          ...
          <ul>
              ...
              <li>
                Resolved hardware and software issues, including password 
                resets, and software installations.
              </li>

              <li>
                Installed software and patches, scanned computers, and 
                updated antivirus programs that were accomplished for 
        ...
        <div className="experience-item">
          ...
          <ul>
            ...
            <li>
              Streamlined record-keeping processes, guaranteeing accurate and timely 
              transaction documentation for clients; achieved 100% compliance with 
              record delivery deadlines and received commendation from senior 
              management.
            </li>

            <li>
              Developed strong relationships with customers personally and over the 
              phone in response to their questions and concerns, ensuring their 
